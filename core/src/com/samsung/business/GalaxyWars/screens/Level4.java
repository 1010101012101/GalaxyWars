...
public class Level4 extends AbstractScreen {
    ...
    public Level4(GalaxyWars galaxyWars) {
        font = new BitmapFont();
    ...
    public void create() {
        ...
        invasion.listenOnInvasionDestroyed(new com.samsung.business.GalaxyWars.entity.Invasion.OnInvasionDestroyed() {
            ...
            public void onInvasionDestroyed() {
                galaxyWars.win4();
                com.samsung.business.GalaxyWars.entity.Invasion.ENEMY_IN_ROW_COUNT=30;
                com.samsung.business.GalaxyWars.entity.Invasion.ENEMY_ROWS_COUNT=5;
    ...
    public void render(float delta) {
        ...
        font.draw(galaxyWars.batch, "Level 4", 10,height-10);
