...
public class Winscreen4 extends AbstractScreen {
    private final GalaxyWars galaxyWars;
    private OrthographicCamera camera;
    private BitmapFont font;
    private TouchInput touchInput;

    public Winscreen4(GalaxyWars galaxyWars) {
        font = new BitmapFont();
    ...
    public void render(float delta) {
        ...
        font.draw(galaxyWars.batch, "You Won Level 4! " + galaxyWars.getScore().getValue(), 10, Gdx.graphics.getHeight()/2);
        font.draw(galaxyWars.batch, "Touch screen to go to next level", 10, (Gdx.graphics.getHeight()/2)-50);
