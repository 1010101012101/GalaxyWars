...
public class Level1 extends AbstractScreen {
    ...
    public Level1(GalaxyWars galaxyWars) {
        font = new BitmapFont();
    ...
    public void create() {
        ...
        invasion.listenOnInvasionDestroyed(new Invasion.OnInvasionDestroyed() {
            ...
            public void onInvasionDestroyed() {
                galaxyWars.win1();
                Invasion.ENEMY_IN_ROW_COUNT=6;
                Invasion.ENEMY_ROWS_COUNT=1;
                Invasion.ENEMY_HEIGHT = 30;
                Invasion.ENEMY_WIDTH = 30;
                dispose();
            }
        });
    ...
    public void render(float delta) {
        ...
        font.draw(galaxyWars.batch, "Level 1", 10,710);
