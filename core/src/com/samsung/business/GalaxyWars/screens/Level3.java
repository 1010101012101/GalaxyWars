...
public class Level3 extends AbstractScreen {
    ...
    public Level3(GalaxyWars galaxyWars) {
        font = new BitmapFont();
    ...
    public void create() {
        ...
        invasion.listenOnInvasionDestroyed(new com.samsung.business.GalaxyWars.entity.Invasion.OnInvasionDestroyed() {
            ...
            public void onInvasionDestroyed() {
                ...
                com.samsung.business.GalaxyWars.entity.Invasion.ENEMY_ROWS_COUNT=3;
    ...
    public void render(float delta) {
        ...
        font.draw(galaxyWars.batch, "Level 3", 10,height-10);
