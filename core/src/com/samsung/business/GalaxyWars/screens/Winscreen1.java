...
public class Winscreen1 extends AbstractScreen {
    private final GalaxyWars galaxyWars;
    private OrthographicCamera camera;
    private BitmapFont font;
    private TouchInput touchInput;

    public Winscreen1(GalaxyWars galaxyWars) {
        font = new BitmapFont();
    ...
    public void render(float delta) {
        ...
        font.draw(galaxyWars.batch, "You Won Level 1! " + galaxyWars.getScore().getValue(), 10, Gdx.graphics.getHeight()/2);
